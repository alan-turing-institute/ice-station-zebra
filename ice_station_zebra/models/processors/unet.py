...
class UNetProcessor(nn.Module):
    ...
    def __init__(self, 
        ...
        # Bottleneck
        self.conv5 = BottleneckBlock(channels[256], channels[512], filter_size=filter_size)
        ...
        self.up9b = ConvBlock(channels[128], channels[64], filter_size=filter_size, final=True)
...
class BottleneckBlock(nn.Module):
    def __init__(self, in_channels: int, out_channels: int, *, filter_size: int=3, 
        ) -> None:
        super().__init__()
