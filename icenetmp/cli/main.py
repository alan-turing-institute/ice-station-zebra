...
from icenetmp.data_processors.cli import datasets_cli
from icenetmp.evaluation.cli import evaluation_cli
from icenetmp.plugins import register_plugins
from icenetmp.training.cli import training_cli
