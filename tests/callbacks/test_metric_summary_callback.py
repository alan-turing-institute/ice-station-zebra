...
from icenet_mp.models.metrics.base_metrics import RMSEDaily, MAEDaily
...
class TestMetricSummaryCallbackInit:
    ...
    def test_init_with_average_loss_true(self):
    ...
    def test_init_with_average_loss_false(self):
...
class TestOnTestBatchEnd:
    ...
    def test_on_test_batch_end_with_valid_output(self, callback, mock_trainer, mock_module):
        """Test that loss is accumulated when output is ModelTestOutput."""
        loss_value = 0.5
        prediction = torch.randn(1, 10)
        target = torch.randn(1, 10)
        output = ModelTestOutput(loss=torch.tensor(loss_value), prediction=prediction, target=target)
    ...
    def test_on_test_batch_end_with_invalid_output(self, callback, mock_trainer, mock_module):
    ...
    def test_on_test_batch_end_multiple_batches(self, callback, mock_trainer, mock_module):
...
class TestOnTestEpochEnd:
    ...
    def test_on_test_epoch_end_logs_average_loss(self, callback, mock_trainer, mock_module):
    ...
    def test_on_test_epoch_end_with_empty_metrics(self, callback, mock_trainer, mock_module):
...
class TestOnTestEnd:
    ...
    def test_on_test_end_with_metric_collection(self, callback, mock_trainer, mock_module):
    ...
    def test_on_test_end_with_invalid_test_metrics(self, callback, mock_trainer, mock_module):
...
class TestMetricCalculations:
    ...
    def test_calculates_mean_mae_correctly(self, callback, mock_trainer, mock_module):
    ...
    def test_calculates_mean_mae_daily_correctly(self, callback, mock_trainer, mock_module):
        """Test that MAE daily is calculated correctly """
        # Convert 2D tensor to 5D tensor: (batch, channels, height, width, time)
        preds_2d = torch.tensor([[1.0, 2.0, 4.0], [1.0, 3.0, 4.0], [2.0, 3.0, 5.0], [2.0, 4.0, 6.0]])
        targets_2d = torch.tensor([[1.5, 2.5, 4.0], [0.5, 3.5, 4.0], [2.0, 4.0, 5.0], [2.5, 3.0, 6.0]])
    ...
    def test_calculates_mean_rmse_correctly(self, callback, mock_trainer, mock_module):
    ...
    def test_calculates_mean_rmse_daily_correctly(self, callback, mock_trainer, mock_module):
    ...
    def test_calculates_sieerror_new_daily_correctly(self, callback, mock_trainer, mock_module):
    ...
    def test_calculates_sieerror_new_scaled_by_pixel_size(self, callback, mock_trainer, mock_module):
